                    ...
                    <td className="border border-gray-300 px-3 py-2">
                      <div className="flex items-center">
                        <input
                          ...
                          value={margin}
                          onChange={(e) => onMarginChange(inquiry._id, product.productId, e.target.value)}
                          placeholder="0"
                          min="0"
                          step="0.1"
                        />
                    ...
                    <td className="border border-gray-300 px-3 py-2">
                      <div className="flex items-center">
                        <input
                          ...
                          className="w-16 px-2 py-1 text-sm border border-gray-300 rounded focus:ring-blue-500 focus:border-blue-500"
                          value={discount}
                          onChange={(e) => onDiscountChange(inquiry._id, product.productId, e.target.value)}
                          placeholder="0"
                          min="0"
                          step="0.1"
                        />
                    ...
                    <td className="border border-gray-300 px-3 py-2">
                      <div className="flex items-center">
                        <input
                          ...
                          className="w-16 px-2 py-1 text-sm border border-gray-300 rounded focus:ring-blue-500 focus:border-blue-500"
                          value={gstRate}
                          onChange={(e) => onGstRateChange(inquiry._id, product.productId, e.target.value)}
                          placeholder="0"
                          min="0"
                          max="100"
                          step="0.1"
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  onChange={(e) => onDeliveryChargeChange(inquiry._id, e.target.value)}
